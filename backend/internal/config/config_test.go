...
func strongProductionConfig() Config {
	return Config{
		...
		ObjectStoragePublicEndpoint:"https://media.filmiqoo.example",
		ObjectStorageBucket:"filmiqoo-media",
		ObjectStorageKey:"filmiqoo-prod",
		ObjectStorageSecret:"00112233445566778899aabbccddeeff0011223344556677",
		PublicAPIBaseURL:"https://api.filmiqoo.example",
		...
		PublicSearchRateLimit:60,
		RealtimeConnectionsPerUser:8,
		UploadDailyCountLimit:100,
		UploadDailyBytesLimit:10*1024*1024*1024,
		PostgresMaxConns:40,
		PostgresMinConns:4,
		RedisPoolSize:60,
		APIRequestTimeoutSeconds:20,
		PushMaxAttempts:6,
